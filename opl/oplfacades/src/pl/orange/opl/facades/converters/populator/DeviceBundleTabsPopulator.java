		...
		extends AbstractProductBundleTabsPopulator<SOURCEPRODUCT, TARGETPRODUCT, SOURCETEMPLATE>
{
	...
	{
		final ArrayList<SOURCETEMPLATE> approvedTemplates = new ArrayList<SOURCETEMPLATE>();
		for (final BundleTemplateModel bundle : productModel.getBundleTemplates())
		{
			if (BundleTemplateStatusEnum.APPROVED.equals(bundle.getStatus().getStatus()))
			{
				approvedTemplates.add((SOURCETEMPLATE) bundle);
			}
		}
