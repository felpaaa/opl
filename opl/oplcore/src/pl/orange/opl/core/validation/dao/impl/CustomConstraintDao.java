 ...
 *  
 */
package pl.orange.opl.core.validation.dao.impl;
...
import pl.orange.opl.core.jalo.ClassificationNotBlankConstraint;
import pl.orange.opl.core.model.ClassificationNotBlankConstraintModel;

import java.util.List;


/**
 * Overrides the DefaultConstraintDao to allow more than 1 {@link ClassificationNotBlankConstraint} per target (= type
 * to be checked). As the {@link ClassificationNotBlankConstraint} inherits from TypeConstraint the DefaultConstraintDao
 * would select the constraints by the attributes target, annotation and active only. But the
 * {@link ClassificationNotBlankConstraint}s need to have the additional attributes category and classification to be
 * unique.
 */
