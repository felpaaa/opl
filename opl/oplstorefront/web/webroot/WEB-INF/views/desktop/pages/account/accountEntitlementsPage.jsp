                            ...
                            <tr>
                                ...
                                <td headers="start">
                                    <ycommerce:testId code="redundant">
                                        <p><fmt:formatDate value="${grant.startTime}" dateStyle="long" timeStyle="short" type="date"/></p>
                                    </ycommerce:testId>
                                </td>
                                <td headers="end">
                                    <ycommerce:testId code="redundant">
                                        <c:choose>
                                            ...
                                            <c:otherwise>
                                                <p><fmt:formatDate value="${grant.endTime}" dateStyle="long" timeStyle="short" type="date"/></p>
                                            </c:otherwise>
                                        </c:choose>
                                    </ycommerce:testId>
                                </td>
