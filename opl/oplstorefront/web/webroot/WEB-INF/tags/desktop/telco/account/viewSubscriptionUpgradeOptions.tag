        ...
        <div class="tabs">
            <c:forEach items="${upgradeOptions}" var="upgradeOptionTab" varStatus="upgradeOptionTabCounter">
                ...
                <div class="tabbody">
                        ...
                        <button class="function_btn right viewPotentialUpgradeBillingDetails" data-url="/oplstorefront/my-account/viewPotentialUpgradeBillingDetails?subscriptionId=${subscriptionData.id}&upgradeId=${upgradeOptionTab.code}">
