 ...
 *  
 */
package pl.orange.opl.storefront.filters.btg.support.impl;
...
import pl.orange.opl.storefront.filters.btg.support.BTGSegmentStrategy;
...
public class DefaultBTGSegmentStrategy implements BTGSegmentStrategy
{
	 ...
	 * @return true if the user is anonymous else false, if false was passed for <param>anonymousSessionCheckFlag</param>
	 *         a true is returned.
	 */
	protected boolean shouldEvaluateAnonymousSession(final UserModel currentUser, final boolean anonymousSessionCheckFlag)
	{
