...
import pl.orange.opl.storefront.forms.UpdateEmailForm;
import pl.orange.opl.storefront.forms.UpdatePasswordForm;
import pl.orange.opl.storefront.forms.UpdateProfileForm;
...
public class AccountPageController extends AbstractSearchPageController
{
			...
			throws CMSItemNotFoundException
	{
        ...
        model.addAttribute("firstAddress", userFacade.getAddressBook().size() == 1);
        model.addAttribute("hasErrors", true);
    ...
    public String entitlements(final Model model) throws CMSItemNotFoundException
    {
        ...
        if(entitlements == null) {
            model.addAttribute("grants", Collections.emptyList());
        }
        else
		{
        ...
        model.addAttribute("metaRobots", "no-index,no-follow");
        return ControllerConstants.Views.Pages.Account.AccountEntitlementsPage;
    }
}
