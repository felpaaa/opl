 ...
 *  
 */
package pl.orange.opl.storefront.interceptors.beforecontroller;
...
public class SecureRequestCookieCheckBeforeControllerHandler implements BeforeControllerHandler
{
	...
	@Override
	public boolean beforeController(final HttpServletRequest request, final HttpServletResponse response) throws Exception //NOPMD
	{
