 ...
 *
 */
package pl.orange.opl.storefront.controllers.pages.payment;
...
import pl.orange.opl.storefront.breadcrumb.ResourceBreadcrumbBuilder;
import pl.orange.opl.storefront.constants.WebConstants;
import pl.orange.opl.storefront.controllers.ControllerConstants;
import pl.orange.opl.storefront.controllers.pages.AbstractPageController;
import pl.orange.opl.storefront.controllers.pages.checkout.MultiStepCheckoutController;
import pl.orange.opl.storefront.controllers.pages.checkout.MultiStepCheckoutController.CheckoutSteps;
import pl.orange.opl.storefront.controllers.pages.checkout.MultiStepCheckoutController.SelectOption;
import pl.orange.opl.storefront.controllers.util.CartHelper;
import pl.orange.opl.storefront.controllers.util.GlobalMessages;
import pl.orange.opl.storefront.forms.AddressForm;
import pl.orange.opl.storefront.forms.PaymentDetailsForm;
import pl.orange.opl.storefront.forms.PaymentSubscriptionsForm;
import pl.orange.opl.storefront.forms.SopPaymentDetailsForm;
			...
			@RequestParam("targetArea") final String targetArea) throws CMSItemNotFoundException
	{
		...
		if (Config.getBoolean("accelerator.storefront.checkout.multistep.sop", false))
		{
			...
			else
			{
				...
				if (null == sopPaymentDetailsForm.getNewBillingAddress())
				{
