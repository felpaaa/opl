 ...
 *  
 */
package pl.orange.opl.storefront.web.theme;
...
public class CustomResourceBundleThemeSource implements ThemeSource, ResourceLoaderAware
{
	...
	public Theme getTheme(final String themeName)
	{
		...
		synchronized (this.themeCache)
		{
			...
			final MessageSource themeUiExperienceMessageSource = createMessageSource(themeBasename + "-" + uiExperienceCode, themeMessageSource);
			final MessageSource siteMessageSource = createMessageSource(siteBasename, themeUiExperienceMessageSource);
			final MessageSource siteUiExperienceMessageSource = createMessageSource(siteBasename + "-" + uiExperienceCode, siteMessageSource);
			...
			{
				LOG.debug("Theme created: name '" + themeName + "', siteBasename [" + siteBasename + "], themeBasename ["
						+ themeBasename + "]");
			}
			return theme;
		}
