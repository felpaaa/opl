 ...
 *  
 */
package pl.orange.opl.storefront.tags;
...
public class Functions
{
			...
			final int entryNumber, final BillingTimeData billingTime)
	{
		...
		if (cart != null && orderPriceData != null)
		{
			return doesPromotionExistForOrderEntry(orderPriceData.getAppliedProductPromotions(), entryNumber);
			...
			final int entryNumber, final BillingTimeData billingTime)
	{
		...
		if (cart != null && orderPriceData != null)
		{
			return doesPromotionExistForOrderEntry(orderPriceData.getPotentialProductPromotions(), entryNumber);
	...
	/**
	 * Check if product promotions are assigned to the given orderEntry
	 */
