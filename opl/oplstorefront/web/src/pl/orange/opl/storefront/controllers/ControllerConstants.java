 ...
 *  
 */
package pl.orange.opl.storefront.controllers;
	...
	interface Views
	{
		...
		interface Pages
		{
			interface Account
			{
				...
				String AccountAddPaymentMethodPage = "pages/account/accountAddPaymentMethod";
				String AccountPaymentMethodSubscriptionsPage = "pages/account/accountPaymentMethodSubscriptionsPage";
				String AccountRegisterPage = "pages/account/accountRegisterPage";
				String AccountSubscriptionBillingActivityPage = "pages/account/accountSubscriptionBillingActivityPage";
				...
				String AccountUpgradeSubscriptionComparisonPage = "pages/account/accountUpgradeSubscriptionComparisonPage";
				String AccountUpgradeSubscriptionPotentialBillingDetails = "pages/account/accountUpgradePotentialBillingDetails";
                String AccountEntitlementsPage = "pages/account/accountEntitlementsPage";
			}
			...
			interface Payment
			{
				String ConfirmDeletePaymentMethodNoSubscriptions = "pages/payment/paymentConfirmDeletePage";
				String RemoveAndReplacePaymentMethod = "pages/payment/paymentChangeForSubscriptions";
				String WarningExistingPaymentSubscriptions = "pages/payment/paymentRemoveForwardToManageSubscriptions";
				String PaymentNotFound = "pages/payment/paymentNotFoundPage";
			}
