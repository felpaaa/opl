 ...
 *  
 */
package pl.orange.opl.storefront.controllers.misc;

import de.hybris.platform.commercefacades.order.data.CartData;
import de.hybris.platform.commercefacades.order.data.CartModificationData;
import de.hybris.platform.commerceservices.order.CommerceCartModificationException;
import pl.orange.opl.storefront.controllers.AbstractController;
...
public class TelcoAddToCartController extends AbstractController
{
			...
			@RequestParam(value = "bundleTemplateId2", required = false) final String bundleTemplateId2)
	{
		...
		try
		{
			final List<CartModificationData> cartModifications = cartFacade.addToCart(productCode1, -1, bundleTemplateId1,
