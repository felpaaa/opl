 ...
 */
package pl.orange.opl.storefront.interceptors;
...
import pl.orange.opl.storefront.util.CSRFHandlerInterceptor;
import pl.orange.opl.storefront.util.CSRFTokenManager;
...
{
	private static final String SESSION_CSRF_ATTRIBUTE = "pl.orange.opl.storefront.util.CSRFTokenManager.tokenval";
	...
	public void shouldPassOnExemptUrl() throws Exception
	{
		...
		try
		{
			...
			BDDMockito.given(request.getServletPath()).willReturn("/paymentDetails/sop-response?targetArea=accountArea");
			final boolean verified = csrfHandlerInterceptor.preHandle(request, response, null);
